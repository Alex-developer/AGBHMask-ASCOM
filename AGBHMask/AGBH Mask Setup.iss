...
; Generated by Alex Greenland on 31/12/2020 (UTC)
;
[Setup]
AppID={{0e040e99-58e2-4de8-a318-5e71097569b2}
AppName=ASCOM AGBH Mask Switch Driver
AppVerName=ASCOM AGBH Mask Switch Driver 1.0.1
AppVersion=1.0.1
AppPublisher=Alex Greenland <alex.greenland@gmail.com>
AppPublisherURL=mailto:alex.greenland@gmail.com
...
OutputDir="."
OutputBaseFilename="AGBH Mask Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Switch\AGBH Mask"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Switch\AGBH Mask"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\g7jgq\source\repos\AGBHMask\AGBHMask\bin\Release\ASCOM.AGBHMask.Switch.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\g7jgq\source\repos\AGBHMask\AGBHMask\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.AGBHMask.Switch.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.AGBHMask.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.AGBHMask.Switch.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.AGBHMask.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.AGBHMask.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
